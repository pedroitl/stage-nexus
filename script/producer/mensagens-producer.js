    ...
    <div className="menu-suspenso-producer">
        <div className="logo-busca">
            ...
            <div className="busca">
                ...
                <a href="../../pages/producer/busca-producer.html"><i className="bi bi-search"></i></a>
            </div>
        ...
        <div className="barra-logout">
            <div className="barra-tarefas">
                ...
                <a href="/pages/producer/oportunidade-producer.html" className="oportunidade"><i className="bi bi-briefcase"></i></a>
                <a href="/pages/producer/notificacoes-producer.html" className="notificacao"><i className="bi bi-bell"></i></a>
                <a href="/pages/producer/mensagens-producer.html" className="mensagem"><i className="bi bi-chat"></i></a>
                <a href="/pages/producer/perfil-producer.html" className="perfil"><i className="bi bi-person"></i></a>
            </div>
            <div className="logout">
                <a href="../../index.html"><i className="bi bi-box-arrow-right"></i></a>
            </div>
        </div>
